          ...
          <AnimatePresence>
            {tooltip && (
              <motion.div
                ...
                className="relative bg-white rounded-xl shadow-xl px-4 py-3 max-w-[200px] border border-gray-100"
              >
                <button
                ...
                {/* Arrow */}
                <div className="absolute bottom-3 right-[-6px] w-3 h-3 bg-white border-r border-b border-gray-100 rotate-[-45deg]" />
              </motion.div>
            )}
          </AnimatePresence>
